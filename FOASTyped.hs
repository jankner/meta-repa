...
showBinOp d Min   a b = showParen (d > 10) $ showString "min " . showsPrec 11 a . showString " " . showsPrec 11 b
showBinOp d Max   a b = showParen (d > 10) $ showString "max " . showsPrec 11 a . showString " " . showsPrec 11 b
...
showBinOp d Pow   a b = showParen (d > 8) $ showsPrec 8 a . showString " ** " . showsPrec 7 b
...
eq (Rec t1 a1 b1)             (Rec t2 a2 b2)             = t1 == t2 && a1 `eq` a2 && b1 `eq` b2 
...
unwrap t@(TTup2 t1 t2) e = caseE e [match (return (typeToPatternB "w" t)) (normalB (unwrapVar "w" t)) []]
unwrap t@(TTupN ts)    e = caseE e [match (return (typeToPatternB "w" t)) (normalB (unwrapVar "w" t)) []]
unwrap t               e = e
